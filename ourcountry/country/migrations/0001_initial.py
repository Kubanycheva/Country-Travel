    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('places_image', models.ImageField(blank=True, null=True, upload_to='places_images')),
            ],
        ),
        migrations.CreateModel(
            name='Regions',
            fields=[
                ...
                ('regions_image', models.ImageField(blank=True, null=True, upload_to='regions_images/')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='regions_reviews', to='country.popularplaces')),
            ],
        ),
        migrations.AddField(
            model_name='popularplaces',
            name='regions',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='country.regions'),
        ),
        migrations.CreateModel(
            name='CountryFood',
            fields=[
                ...
                ('regions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='country.regions')),
            ],
        ),
    ]
